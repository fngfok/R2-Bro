...
app.use((req, res, next) => {
  ...
  // Security Enhancement: frame-ancestors 'none' prevents clickjacking; upgrade-insecure-requests enforces HTTPS
...
// Optimization: Map to store in-flight promises for concurrent request coalescing (Thundering Herd protection)
