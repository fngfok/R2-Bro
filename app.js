...
function isValidAllyCode(allyCode) {
  ...
  // Security: Enforce explicit length limit before processing to prevent DoS
...
// Security: Limit body size and use simple parser to mitigate DoS and prototype pollution
